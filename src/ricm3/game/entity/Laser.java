...
public class Laser extends Being {
	...
	public void splitter() {
		...
		if (global_map.getEntity(p.x, p.y) == null) { // tile in front is free
			...
			laser1 = new Laser(p1.x, p1.y, this.getSprites(), m_model.m_idb.nbFrameLaser,this.getAutomaton(), this.getOrientation(), global_map,
					m_model, this.getLife(), this.getLastMove());
			laser2 = new Laser(p2.x, p2.y, this.getSprites(), m_model.m_idb.nbFrameLaser, this.getAutomaton(), this.getOrientation(), global_map,
					m_model, this.getLife(), this.getLastMove());
